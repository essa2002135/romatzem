...
public class papaer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papaer);
        req = Volley.newRequestQueue(this);

        viewDialog = new ViewDialog(this);

            ImageView theTitleHeader = (ImageView) findViewById(R.id.title);

        TheTypee = getIntent().getStringExtra("TheType");
            if (TheTypee.equals("3"))
            {
                theTitleHeader.setImageResource(R.drawable.nasharatname);
            }
            else
            {
                theTitleHeader.setImageResource(R.drawable.knokname);
    ...
    private void jasonParse(String TheTypeID)
    {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                customAdabterPaper theCustomAdabter = new customAdabterPaper();
                ...
                myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        String urlFile = "http://backpain.q8-ehealth.com/uploads/files/"+thePdfName;
    ...
    class customAdabterPaper extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view = getLayoutInflater().inflate(R.layout.custom_paper,null);
            TextView myText = (TextView) view.findViewById(R.id.textView4);
            TextView theDateText = (TextView) view.findViewById(R.id.textView5);
            TextView theDes = (TextView) view.findViewById(R.id.textView6);

            ImageView theImageView = (ImageView) view.findViewById(R.id.imageView11);

            myText.setText(thetitle.get(position));
            theDateText.setText(theDate.get(position));
